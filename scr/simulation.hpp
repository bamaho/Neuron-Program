...
class Simulation
{
	...
	void printDataForBrunelFigureToFile(double ratioJinoverJexG, double ratioVextOverVthr, unsigned int timeBeginMeasurement = TIME_BEGIN_PRINT_TO_TXT_FILE_BY_DEFAULT, unsigned int timeEndMeasurement = TIME_END_PRINT_TO_TXT_FILE_BY_DEFAULT, const std::string& nameOfFile = "simulationData.txt");
