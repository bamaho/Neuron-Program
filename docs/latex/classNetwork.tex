...
\begin{DoxyParams}{Parameters}
{\em a} & member function of neuron that yields an unsigned int \\
\hline
\end{DoxyParams}
...
\hline
{\em end} & of the interval to investigate in steps, an unsigned int \\
\hline
\end{DoxyParams}
...
\begin{DoxySeeAlso}{See Also}
\hyperlink{classSimulation_a842b9a8457fec98727ce838a8f165e87}{Simulation\-::print\-Data\-For\-Brunel\-Figure\-To\-File()} 
\end{DoxySeeAlso}
